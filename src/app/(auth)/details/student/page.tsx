...
const StudentDetailsPage: NextPage = () => {
  ...
  const {
    ...
    formState: { errors: addStudentErrors, isValid },
  ...
  const onSubmit = async (data: any) => {
    ...
    formdata.append('personal_interests', data?.personal_interests);
            ...
            <Box className="main-box">
              ...
              <div className="sm-flex-col-col-center scrollable-container  ">
                {fieldsInputs.map((item) => (
                  <FormField
                    ...
                    apiErrors={addStudentErrors[item.name]?.message}
                  />
                ))}
              </div>
              <div className=" sm-flex-row-row-center-between  w-full mt-2 ">
                ...
                <LoadingButton
                  type="submit"
                  variant="outlined"
                  onClick={handleStudentSubmit(onSubmit)}
